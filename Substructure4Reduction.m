...
A22=K4([221:231],[221:231]);
A42=K4([1:220,232:462],[221:231]);
A52=K4([1:220,232:462],[1:220,232:462]);
% Forming Mii(Mass submatrix with interior modes
MA52=M4([1:220,232:462],[1:220,232:462]);
psic=-inv(A52)*A42;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
A=K4([221:231],[221:231]);
A4=K4([1:220,232:462],[221:231]);
A5=K4([1:220,232:462],[1:220,232:462]);
A6=K4([221:231],[1:220,232:462]);
H=horzcat(A5,A4);
H1=horzcat(A6,A);
Kf=vertcat(H,H1);
%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
KA=M4([221:231],[221:231]);
KA4=M4([1:220,232:462],[221:231]);
KA5=M4([1:220,232:462],[1:220,232:462]);
KA6=M4([221:231],[1:220,232:462]);
KH=horzcat(A5,A4);
KH1=horzcat(A6,A);
Mf=vertcat(KH,KH1);
